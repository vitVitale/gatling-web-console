package org.testing.pt.webui.controller;
...
import org.testing.pt.webui.service.TestService;
...
public class DashboardController {
    ...
    public String dashboard(Model model) {
        ...
        List<TestExecution> recentTests = testService.getAllTests();
    ...
    public String handleRunTest(
        ...
        try {
            ...
            TestExecution execution = testService.uploadAndRunTest(testJar, testClass, description, parameters);
    ...
    public String results(Model model) {
        ...
        List<TestExecution> tests = testService.getAllTests();
    ...
    public String resultDetails(@PathVariable String id, Model model) {
        TestExecution test = testService.getTest(id);
    ...
    public String stopTest(@PathVariable String id, RedirectAttributes redirectAttributes) {
        boolean stopped = testService.stopTest(id);
